...
HTMLActuator.prototype.tileHTML = ["啊", "死", "冰", "卧操", "击败", "Allin", "说的道理", "哈比下", "奥利安费", "哈利路大旋风", "口圭 衤夭"]
...
GameManager.prototype.PlaySound = function (musicId){
    ...
    console.log(music);
    console.log(music.paused); music.play();
    if (music.paused) {
        music.paused = false;
